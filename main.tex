...
\addtofrontsidebar{
	...
	\profilesection{Computer Skills}
		...
		\pointskill{}{R Shiny}{3}
		\pointskill{}{BI (Tableau)}{3}
		\pointskill{}{SQL}{3}
		\pointskill{}{Python}{3}
		%\pointskill{}{SPSS}{3}
  	    \pointskill{}{HTML}{2}
...
\begin{cvtable}
	\cvitem{2016 -- present}{Neuroscientist}{Université de Lausanne, Switzerland}{
	...
	- Reference person within the laboratory on statistics and programming\newline
...
\begin{cvtable}
	\cvitem{2021}{\emph{EMBO Reports (in press)}}{}{\textbf{Absence of RNA binding protein FXR2P prevents prolonged phase of kainate-induced seizures} \newline \textbf{Lo AC}*, Rajan N*, Telley T, Hilal ML, Buzzi A, Simonato M, Achsel T, Bagni C. * authors contributed equally}
