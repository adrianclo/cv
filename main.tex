...
\addtofrontsidebar{
	...
	\aboutme{
		I have a background in theoretical psychology and \textbf{statistics}. During the last 5 years I studied rodent behavior and molecular biology, but also gained expertise in developing \textbf{R programs}, \textbf{shiny apps} and \textbf{automated reports}. Wth these tools, I improved the speed and efficiency of data-processing for myself as well as colleagues.
	}
...
\begin{cvtable}
	\cvitem{2016 -- present}{Neuroscientist}{Université de Lausanne, Switzerland}{Post-doctoral research focused on understanding the role of the RNA binding protein FXR2P in status epilepticus: Behavioral and molecular evaluation (Laboratory of Prof. Claudia Bagni)}
